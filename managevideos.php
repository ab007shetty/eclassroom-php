	...
	<div class="row">
		...
		?>
			...
			<tr >
				...
				<td 
					<div style="width:560px; height:315px;"><?PHP echo $row['V_Url'];?> </div>
				</td>
				<td>
				...
				<td><a href="managevideos2.php?editassid=<?php echo $row['V_id']; ?>"> <input type="button" Value="Edit"  class="btn btn-warning btn-sm"  data-toggle="modal" data-target="#myModal"></a>
				</td>
				</td>
			</tr>
			<?php
