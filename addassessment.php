				...
				<form action="" method="POST" name="AddAssessment">
					<table class="table table-hover">
						...
						<tr>
							...
							<td>
								<input class="form-control" type="text" name="AssessmentName">
							</td>
						...
						<tr>
							...
							<td>
								<textarea class="form-control" name="Q1" rows="5" cols="150"></textarea>
							</td>
						</tr>
						<tr>
							<td><strong>Question 2</strong> </td>
							<td>
								<textarea class="form-control" name="Q2" rows="5" cols="150"></textarea>
							</td>
						</tr>
						<tr>
							<td><strong>Question 3</strong> </td>
							<td>
								<textarea class="form-control" name="Q3" rows="5" cols="150"></textarea>
							</td>
						</tr>
						<tr>
							<td><strong>Question 4</strong> </td>
							<td>
								<textarea class="form-control" name="Q4" rows="5" cols="150"></textarea>
							</td>
						</tr>
						<tr>
							<td><strong>Question 5</strong> </td>
							<td>
								<textarea class="form-control" name="Q5" rows="5" cols="150"></textarea>
							</td>
						</tr>
						
						<td><button type="submit" name="submit" class="btn btn-success">Add Assessment</button>
						</td>
