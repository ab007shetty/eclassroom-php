				...
				?>
					<div class="col-md-12">
						...
						<div class="form-group row">
							...
							<div class="col-md-12">
							<textarea class="form-control" name="Q1" rows="5" placeholder="Write Your Answer Here." required ></textarea>
							</div>
						</div>
						...
						<br>
							...
							<div class="col-md-12">
							<textarea class="form-control" name="Q2" rows="5" placeholder="Write Your Answer Here." required ></textarea>
							</div>
						</div>
						<br>
							...
							<div class="col-md-12">
							<textarea class="form-control" name="Q3" rows="5" placeholder="Write Your Answer Here." required ></textarea>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-12">
							<textarea class="form-control" name="Q4" rows="5" placeholder="Write Your Answer Here." required ></textarea>
							</div>
						</div>
						<br>
						...
						<div class="form-group row">
							...
							<div class="col-md-12">
							<textarea class="form-control" name="Q5" rows="5" placeholder="Write Your Answer Here." required ></textarea>
							</div>
						</div>
						<br>
					...
					?>
						...
						<br>
						<button type="submit" name="done" class="btn btn-success">I am Done!</button>
					</div>
