				...
				<form action="" method="POST" name="UpdateAssessment">
					<table class="table table-hover">
						...
						<td ><strong>Exam Name</strong>
							...
							<td >
							<textarea class="form-control" name="ExamName" rows="1" cos="50"><?php $ExamName=$row['ExamName']; echo $ExamName; ?></textarea>
							</td>
						...
						<tr>
							...
							<td >
							<textarea class="form-control" name="Q1" rows="5" cls="150"><?php $Q1=$row['Q1']; echo $Q1; ?></textarea>
							</td>
						</tr>	
							<tr>
							<td><strong>Q2</strong>
							...
							<td>
							<textarea class="form-control" name="Q2" rows="5" cos="150"><?php $Q2=$row['Q2']; echo $Q2; ?></textarea>
							</td>
						</tr>	
							<tr>
							<td><strong>Q3</strong>
							...
							<td>
							<textarea class="form-control" name="Q3" rows="5" cls="150"><?php $Q3=$row['Q3']; echo $Q3; ?></textarea>
							</td>
						</tr>	
							<tr>
							<td><strong>Q4</strong>
							...
							<td>
							<textarea class="form-control" name="Q4" rows="5" cos="150"><?php $Q4=$row['Q4']; echo $Q4; ?></textarea>
							</td>
						</tr>	
							<tr>
							<td><strong>Q5</strong>
							...
							<td>
							<textarea class="form-control" name="Q5" rows="5" cos="150"><?php $Q5=$row['Q5']; echo $Q5; ?></textarea>
							</td>
						</tr>	
