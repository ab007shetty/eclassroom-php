				...
				<form action="" method="POST" name="UpdateVideo">
					<table class="table table-hover">
						...
						<td><strong>Video Title</strong>
							...
							<td>
							<textarea class="form-control" name="V_Title" rows="1" ><?php $V_Title=$row['V_Title']; echo $V_Title; ?></textarea>
							</td>
						...
						<tr>
							...
							<td>
							<textarea class="form-control" name="V_Url" rows="8" ><?php $V_Url=$row['V_Url']; echo $V_Url; ?></textarea>
							</td>
						</tr>
						<tr>
							...
							<td>
							<textarea class="form-control" name="V_Remarks" rows="8" ><?php $V_Remarks=$row['V_Remarks']; echo $V_Remarks; ?></textarea>
							</td>
						</tr>							
